...
contract TheSindicate is ERC20Detailed, Ownable {
    ...
    function setIsLiquidityInBNB(bool _value) external onlyOwner {
        ...
        emit SetIsLiquidityInBNB(_value, block.timestamp);
    }
    ...
    event SetPartyIsOver(bool indexed state, uint256 indexed time);
    ...
    event SetIsLiquidityInBNB(bool indexed value, uint256 indexed time);
    ...
    event SetBurnFee(bool indexed value, uint256 indexed time);
